...
<template>
  <header class="w-full border-b border-slate-200 py-6 shadow-xl">
  <div class="container">
  <div class="flex justify-between items-center">
  <div class="flex">
    <img src="../public/images/Vector Logo Design Template Fruit Vegetable Stock Vector (Royalty Free) 326538095 _ Shutterstock.jpeg" style="width: 10%; margin-right: 2%;">
  <NuxtLink to="/" :class="'text-xl font-bold mt-2'" style="color: rgb(45, 87, 2);">ORGANIC - MART</NuxtLink>
  </div>
  ...
  <NuxtLink to="/cart" class="text-base  " style="border-radius: 100%;"><i class="ri-shopping-cart-2-line"></i></NuxtLink>
